...
这是一条独立的**场内ETF行情与一级申购清单**，不是新策略，不写推荐历史/绩效信号，也不占用通用
...
客户卡片与场外申购卡分开发送，标题明确标注“场内交易”。每行突出基金名称、
可点击的六位代码（打开同花顺对应基金介绍）、分类、人民币收盘价及涨跌幅。
...
**申购额度单独取自交易所官方PCF清单**，不是天天基金的场外申购接口，也不从成交额、
...
累计申购与净申购限制分别列出，不合并为一个金额，也不跨基金合计。
暂停申购时不显示残留正数限额。缺失或零值不推断为“不限额”；有效的其他限制仍分别显示，
一个维度未核实不掩盖另一个已经核实的维度。接口失败、代码/日期不符、状态或字段不可信时，
该只明确显示“一级申购额度：未确认”，保留场内行情，不挪用场外额度补齐。
这里的“累计”指**清单交易日内累计**，不是历史累计买入量。卡片明确写“当日单户上限”、
“当日基金整体上限”，并将“实时剩余可申购份额”单列为未确认：公开PCF不提供实时申购占用量，
也没有用户账户今日已申购份额，不能把公布上限直接当成当天还可以买的份额。
非交易日展示最近清单时，明确说明不是今天的可申购份额。
这里是每日公布上限，**不是个人或全市场的实时剩余额度**；二级市场证券账户买卖是另一业务，
暂停一级申购不等于停牌。卡片用短句明确此区别，不堆通用风险文案。
